...
OutPackets = {
    "System Reset": bytes((PKT_HEADR, 0x01, SYS_SRESET, SYS_SRESET)),
    "Watchdog Reset": bytes((PKT_HEADR, 0x01, SYS_WRESET, SYS_WRESET)),
    "DIO 01 Set": bytes((PKT_HEADR, 0x02, DIO_SETVAL, 0x01, DIO_SETVAL ^ 0x01)),
    "DIO 01 Clear": bytes((PKT_HEADR, 0x02, DIO_RSTVAL, 0x01, DIO_RSTVAL ^ 0x01)),
    "DIO 01 Get": bytes((PKT_HEADR, 0x02, DIO_GETVAL, 0x01, DIO_GETVAL ^ 0x01)),
    "Unknown": bytes(
        (
            PKT_HEADR,
            0x05,
